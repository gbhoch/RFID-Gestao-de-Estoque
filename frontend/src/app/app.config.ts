...
export const routes: Routes = [
  { path: 'login', loadComponent: () => import('./features/auth/login.component').then((m) => m.LoginComponent) },
  {
    ...
    children: [
      ...
      { path: 'rfid/:id', loadComponent: () => import('./features/rfid-tags/rfid-tag-manage.component').then((m) => m.RfidTagManageComponent) },
      ...
      { path: 'inventory/:id/reconciliation', loadComponent: () => import('./features/inventory/inventory-reconciliation.component').then((m) => m.InventoryReconciliationComponent) },
